---
name: work3
description: Start the full Nepal Instagram creator discovery workflow for Bagmati Province with /work3.
user-invocable: true
---

# Work3

`work3` runs the full `workking` workflow locked to `Bagmati Province`.
