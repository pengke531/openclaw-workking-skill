---
name: work2
description: Start the full Nepal Instagram creator discovery workflow for Madhesh Province with /work2.
user-invocable: true
---

# Work2

`work2` runs the full `workking` workflow locked to `Madhesh Province`.
