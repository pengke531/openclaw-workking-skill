---
name: work7
description: Start the full Nepal Instagram creator discovery workflow for Sudurpashchim Province with /work7.
user-invocable: true
---

# Work7

`work7` runs the full `workking` workflow locked to `Sudurpashchim Province`.
