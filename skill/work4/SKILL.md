---
name: work4
description: Start the full Nepal Instagram creator discovery workflow for Gandaki Province with /work4.
user-invocable: true
---

# Work4

`work4` runs the full `workking` workflow locked to `Gandaki Province`.
