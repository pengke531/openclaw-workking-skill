---
name: workking2
description: Start the full Nepal Instagram creator discovery workflow for Madhesh Province with /workking2.
user-invocable: true
---

# Workking2

`workking2` runs the full `workking` workflow locked to `Madhesh Province`.
...
- Instagram only
- Nepal only
- province scope must stay `Madhesh Province`
