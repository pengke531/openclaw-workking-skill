---
name: workking6
description: Start the workking Nepal Instagram discovery runner for Karnali Province with /workking6.
user-invocable: true
---

# Workking6

`workking6` starts the shared `workking` runner locked to `Karnali Province`.
