---
name: work1
description: Start the workking Nepal Instagram discovery runner for Koshi Province with /work1.
user-invocable: true
---

# Work1

`work1` starts the shared `workking` runner locked to `Koshi Province`.
